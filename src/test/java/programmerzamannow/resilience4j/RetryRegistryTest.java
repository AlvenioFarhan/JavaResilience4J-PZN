...
public class RetryRegistryTest {
    ...
    void testRetryRegistry() {
        ...
        Retry retry1 = registry.retry("alvenio");
        Retry retry2 = registry.retry("alvenio");
    ...
    void testRetryRegistryConfig() {
        ...
        Retry retry1 = registry.retry("alvenio", "config");
        Retry retry2 = registry.retry("alvenio", "config");
